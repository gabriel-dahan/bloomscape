...
<template>
    <div class="w-screen min-h-screen bg-slate-950 text-slate-200 pt-24 pb-12 px-4 phone:px-8 relative overflow-hidden">
                ...
                <div class="space-y-12 animate-slide-right">
                    ...
                    <div class="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 backdrop-blur-sm">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <a href="https://discord.gg/4sJyaynWdW"
                            ...
                            <a href="https://www.instagram.com/bloomscape.game/"
                                class="btn btn-outline border-fuchsia-800/30 text-fuchsia-700 hover:bg-fuchsia-800 hover:border-fuchsia-800 hover:text-white gap-2"
                                target="_blank">
                                <InstagramIcon />
                                Instagram
                            </a>
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <p>To see more Q&A, see our <RouterLink :to="ROUTES_ENUM.WIKI.path" class="text-indigo-400">Wiki
                            </RouterLink> page !</p>
                    </div>
                </div>
